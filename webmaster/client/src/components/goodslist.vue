  ...
  <div class="goodslist">
    <div class="serachtop">
      ...
      <label for="goodslist">商品种类
        <el-select class="goodsseach" v-model="selectKind" placeholder="商品分类">
          <el-option v-for="(item,idx) in options " :value="item.type" :key="idx" id="goodslist"></el-option>
        </el-select>
    ...
    <div class="table">
      ...
      >
        ...
        <el-table-column prop="type" label="商品分类" show-overflow-tooltip></el-table-column>
        <el-table-column prop="name" label="商品名称" show-overflow-tooltip></el-table-column>
        <el-table-column prop="price" label="价格" sortable show-overflow-tooltip></el-table-column>
        <el-table-column prop="dat" label="时间" sortable show-overflow-tooltip></el-table-column>
        <el-table-column prop="status" label="发布状态" show-overflow-tooltip></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getData: function() {
      this.$axios
        .get(
          this.url + "/goodslist?start=" + this.start + "&count=" + this.count
        )
        .then(res => {
